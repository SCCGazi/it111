...
public class dailySpecialsExtraCredits
{
    public static void main(String[] args)
    {
        ...
        if (specials.equals("tuesday")||specials.equals("TUESDAY")) { specials="Tuesday"; }
        else if (specials.equals("wednesday")||specials.equals("WEDNESDAY")) { specials="Wednesday"; }
        else if (specials.equals("THURSDAY")||specials.equals("thursday")) { specials="Thursday"; }
        else if (specials.equals("friday")||specials.equals("FRIDAY")) { specials="Friday"; }
        else{ System.out.println("Check your spelling!"); }
        switch(specials)
        {
